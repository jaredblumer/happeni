# Pleasant Event Tracker

Inspired by Cognitive Behavioral Therapy (CBT), the Pleasant Event Tracker app empowers users to track and anticipate upcoming pleasant events, with personalized reminders to keep positivity on the horizon.
